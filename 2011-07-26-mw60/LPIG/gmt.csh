...
# 
psbasemap -JM6.5i -R-110.716/-109.133/24.002/25.189 -Ba0.500f0.500/a0.300f0.300NEWS:."":  -X0.75i -Y1.0i -P -K > $psfile 

# Add the Coastline and National Boundaries
# 
pscoast -K -O -J -R -B -N1 -N2 -W -Dl -A2 -G250/250/200  >> $psfile 
